...
|------------|-----|-----------|--------------|
| `/fetch https://example.com` | `https://example.com` | `false` | omit |
| `/fetch https://example.com 3` | `https://example.com` | `false` | `3` |
| `/fetch https://example.com summaryLevel=2` | `https://example.com` | `false` | `2` |
| `/fetch https://example.com js` | `https://example.com` | `true` | omit |
| `/fetch https://example.com js 1` | `https://example.com` | `true` | `1` |
| `/fetch https://example.com 1 js` | `https://example.com` | `true` | `1` |
